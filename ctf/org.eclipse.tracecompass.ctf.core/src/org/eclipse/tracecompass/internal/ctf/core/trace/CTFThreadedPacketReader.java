...
public class CTFThreadedPacketReader implements IPacketReader {
     ...
     */
    public CTFThreadedPacketReader(Executor executor, @NonNull BitBuffer input, @NonNull ICTFPacketDescriptor packetContext, @NonNull List<@Nullable IEventDeclaration> declarations, @Nullable IDeclaration eventHeaderDeclaration, @Nullable StructDeclaration streamContext,
